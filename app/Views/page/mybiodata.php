        ...
        <div class="row">
          <div class="col align-self-center">
            ...
            <?php foreach ($datadiri as $row) : ?>
              ...
              <tr>
                <td><button class="btn btn-success mb-4"><a href="/biodata/add_new">+ Tambah</a></button></td>
                <td><button class="btn btn-warning mb-4 ms-3 "><a href="/biodata/edit/<?= $row['id'];?>">! Edit</a></button>
                <button class="btn btn-danger mb-4 ms-3 "><a href="/biodata/delete/<?= $row['id'];?>">- Hapus</a></button></td>
              </tr>            
